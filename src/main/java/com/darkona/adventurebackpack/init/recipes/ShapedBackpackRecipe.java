...
public class ShapedBackpackRecipe extends ShapedOreRecipe {
    ...
    static {
        RecipeSorter.register(
                ModInfo.MOD_ID + ":shapedbackpackrecipe",
                ShapedBackpackRecipe.class,
    ...
    public ItemStack getCraftingResult(InventoryCrafting craftMatrix) {
        ...
        if (!(craftResult.getItem() == ModItems.adventureBackpack)) return craftResult; // in case recipe is using
                                                                                        // backpack only as ingredient
            ...
            if (matrixStack != null && matrixStack.getItem() == ModItems.adventureBackpack
                ...
                LogHelper.info(
                        "Successfully transferred inventory from the ingredient backpack ["
                                + BackpackTypes.getSkinName(matrixStack)
                                + "] to the crafted backpack ["
