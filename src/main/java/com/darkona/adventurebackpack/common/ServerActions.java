            ...
            if (!te.isSleepingBagDeployed()) {
                ...
                if (can[0] > -1) {
                    ...
                    player.addChatComponentMessage(
                            new ChatComponentTranslation("adventurebackpack:messages.backpack.cant.bag"));
                }
            } else {
    ...
    public static void toggleToolCycling(EntityPlayer player, ItemStack backpack) {
        ...
        if (ConfigHandler.enableToolsCycling) {
            if (inv.getDisableCycling()) {
                ...
                if (player.worldObj.isRemote) {
                    player.addChatComponentMessage(
                            new ChatComponentTranslation("adventurebackpack:messages.cycling.on"));
                }
            } else {
                ...
                if (player.worldObj.isRemote) {
                    player.addChatComponentMessage(
                            new ChatComponentTranslation("adventurebackpack:messages.cycling.off"));
                }
            }
        }
    }
        ...
        if (inv.getDisableNVision()) {
            ...
            if (player.worldObj.isRemote) {
                ...
                if (ConfigHandler.chatSpam) {
                    player.addChatComponentMessage(
                            new ChatComponentTranslation("adventurebackpack:messages.nightvision.on"));
                }
            }
        } else {
            ...
            if (player.worldObj.isRemote) {
                ...
                if (ConfigHandler.chatSpam) {
                    player.addChatComponentMessage(
                            new ChatComponentTranslation("adventurebackpack:messages.nightvision.off"));
                }
            }
        }
    }
