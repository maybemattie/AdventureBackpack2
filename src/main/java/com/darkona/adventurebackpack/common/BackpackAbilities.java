...
public class BackpackAbilities {
    ...
    public void itemBat(EntityPlayer player, World world, ItemStack backpack) {
        ...
        if ((nightVision == null || nightVision.getDuration() < 222)
                && !Wearing.getWearingBackpackInv(player).getDisableNVision()) {
    ...
    public void itemRainbow(EntityPlayer player, World world, ItemStack backpack) {
        ...
        if (noteTime >= 0 && noteTime < Utils.secondsToTicks(147)) {
            ...
            if (ConfigHandler.rainbowBackpackSSpeed != 0) {
                player.addPotionEffect(
                        new PotionEffect(Potion.moveSpeed.getId(), 60, ConfigHandler.rainbowBackpackSSpeed - 1, true));
            }
            if (ConfigHandler.rainbowBackpackSJump != 0) {
                player.addPotionEffect(
                        new PotionEffect(Potion.jump.getId(), 60, ConfigHandler.rainbowBackpackSJump - 1, true));
            }
            if (noteTime % 2 == 0) {
        ...
        if (ConfigHandler.rainbowBackpackSpeed != 0 && (moveSpeed == null || moveSpeed.getDuration() < 222)) {
            player.addPotionEffect(
                    new PotionEffect(Potion.moveSpeed.getId(), 239, ConfigHandler.rainbowBackpackSpeed - 1, true));
        }
    ...
    public void itemSlime(EntityPlayer player, World world, ItemStack backpack) {
        ...
        if (player.onGround) {
            ...
            if ((player.moveForward == 0 && player.moveStrafing == 0)
                    && (Math.abs(player.moveForward) < 3 && Math.abs(player.moveStrafing) < 3)) {
