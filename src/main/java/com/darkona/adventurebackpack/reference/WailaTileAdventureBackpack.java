...
public class WailaTileAdventureBackpack implements IWailaDataProvider {
    ...
    public static void init() {
        FMLInterModComms.sendMessage(
                "Waila",
                "register",
                "com.darkona.adventurebackpack.reference.WailaTileAdventureBackpack.callbackRegister");
    }
    ...
    private static void addTipToBackpack(List<String> currenttip, NBTTagCompound backpackTag) {
        ...
        currenttip.add(
                EnumChatFormatting.RESET + TipUtils.l10n("backpack.tank.left") + ": " + TipUtils.tankTooltip(tank));

        tank.readFromNBT(backpackTag.getCompoundTag(TAG_RIGHT_TANK));
        currenttip.add(
                EnumChatFormatting.RESET + TipUtils.l10n("backpack.tank.right") + ": " + TipUtils.tankTooltip(tank));
    }
